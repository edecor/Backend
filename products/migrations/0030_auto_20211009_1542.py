...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('products', '0029_hardwaretoolproducts_homeapplianceproducts'),
    ]

    operations = [
        migrations.RenameField(
            model_name='hardwaretoolproducts',
            old_name='fabrictextile_product_type',
            new_name='hardwaretool_product_type',
        ),
        migrations.RenameField(
            model_name='homeapplianceproducts',
            old_name='fabrictextile_product_type',
            new_name='homeappliance_product_type',
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('brand', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='products_kitchenproducts_related', related_query_name='products_kitchenproductss', to='products.brand')),
                ('kitchen_product_type', models.ManyToManyField(related_name='kitchen_product_types', related_query_name='kitchen_product_type', to='products.Category')),
                ('supplier', models.ManyToManyField(blank=True, related_name='products_kitchenproducts_related', related_query_name='products_kitchenproductss', to='products.Supplier')),
            ],
            options={
