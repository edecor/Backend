# Generated by Django 3.2.7 on 2021-10-09 15:24
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('products', '0026_furnitureproducts'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('brand', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='products_decorationsproducts_related', related_query_name='products_decorationsproductss', to='products.brand')),
                ('decoration_product_type', models.ManyToManyField(related_name='decoration_product_types', related_query_name='decoration_product_type', to='products.Category')),
                ('supplier', models.ManyToManyField(blank=True, related_name='products_decorationsproducts_related', related_query_name='products_decorationsproductss', to='products.Supplier')),
            ],
            options={
