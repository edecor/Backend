# Generated by Django 3.2.7 on 2021-10-09 15:05
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('products', '0024_auto_20211009_1141'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bathroom_product_type', models.ManyToManyField(related_name='bathroom_product_types', related_query_name='bathroom_product_type', to='products.Category')),
                ('brand', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='products_bathroomproducts_related', related_query_name='products_bathroomproductss', to='products.brand')),
                ('supplier', models.ManyToManyField(blank=True, related_name='products_bathroomproducts_related', related_query_name='products_bathroomproductss', to='products.Supplier')),
            ],
            options={
